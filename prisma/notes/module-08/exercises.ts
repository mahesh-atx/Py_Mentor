  ...
  "creating-dictionaries": [
    {
      ...
      testCases: [
        { input: "", expectedOutput: "{'name': 'Alice', 'age': 30, 'city': 'London'}\n3\n" }
      ],
      difficulty: "beginner",
      xpReward: 15
    },
  ...
  "dictionary-methods": [
    {
      ...
      testCases: [
        { input: "", expectedOutput: "['Alice', 'Bob', 'Charlie']\n[72, 88, 95]\n255\n" }
      ],
      difficulty: "beginner",
      xpReward: 20
    },
  ...
  "dictionary-comprehension": [
    {
      ...
      testCases: [
        { input: "", expectedOutput: "{1: 1, 2: 4, 3: 9, 4: 16, 5: 25, 6: 36, 7: 49, 8: 64, 9: 81, 10: 100}\n" }
      ],
      difficulty: "beginner",
      xpReward: 20
    },
  ...
  "iterating-dictionaries": [
    {
      ...
      testCases: [
        { input: "", expectedOutput: "font = mono\nlang = en\nsize = 14\ntheme = dark\n" }
      ],
      difficulty: "beginner",
      xpReward: 15
    },
