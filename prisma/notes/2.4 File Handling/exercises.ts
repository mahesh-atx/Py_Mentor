export const exercises: Record<string, any[]> = {
  ...
  "writing-appending-files": [
    ...
    {
      "title": "Write to File",
      "prompt": "Open 'output.txt' in write mode ('w'). Write the string 'Success!' to it. Close the file. (The test will automatically read and print it to verify).",
      "starterCode": "# Write 'Success!' to output.txt\n\n\n# Verification (Do not modify)\nwith open('output.txt', 'r') as f: print(f.read())",
      "solutionCode": "f = open('output.txt', 'w')\nf.write('Success!')\nf.close()\n\nwith open('output.txt', 'r') as f: print(f.read())",
      "testCases": [
        {
          "input": "",
  ...
  "context-manager-with": [
    ...
    },
    {
      ...
      "prompt": "Use the `with open(...) as file:` syntax to open 'data.txt' in write mode ('w') and write 'Context Manager' to it. This automatically closes the file.",
      "starterCode": "# Use with statement to write 'Context Manager' to data.txt\n\n\n# Verification\nwith open('data.txt', 'r') as f: print(f.read())",
      "solutionCode": "with open('data.txt', 'w') as f:\n    f.write('Context Manager')\n\nwith open('data.txt', 'r') as f: print(f.read())",
      "testCases": [
        {
          "input": "",
          "expectedOutput": "Context Manager\n"
        }
      ],
      "difficulty": "beginner",
      "xpReward": 20
  ...
  "working-with-csv": [
    ...
    {
      "title": "Write Simple CSV",
      "prompt": "Given `headers = ['id', 'val']` and `row = [1, 100]`. Open 'out.csv' in write mode. Write the headers joined by commas, add a newline, then write the row joined by commas.",
      "starterCode": "headers = ['id', 'val']\nrow = ['1', '100']\n# Write to out.csv\n\n\n# Verification\nwith open('out.csv', 'r') as f: print(f.read())",
      "solutionCode": "headers = ['id', 'val']\nrow = ['1', '100']\nwith open('out.csv', 'w') as f:\n    f.write(','.join(headers) + '\\n')\n    f.write(','.join(row) + '\\n')\n\nwith open('out.csv', 'r') as f: print(f.read())",
      "testCases": [
        {
          "input": "",
          "expectedOutput": "id,val\n1,100\n\n"
        }
      ],
      "difficulty": "advanced",
      "xpReward": 40
  ...
  "working-with-json": [
    ...
    {
      "title": "JSON Dump",
      "prompt": "Import the `json` module. Given a dictionary `data = {'id': 1}`. Use `json.dumps(data)` to convert it to a JSON string and print it.",
    ...
    {
      "title": "JSON Load",
      "prompt": "Import `json`. Given `json_str = '{\"status\": \"ok\"}'`. Use `json.loads(json_str)` to parse it into a dictionary, then print the value of 'status'.",
  ...
  "file-directory-operations": [
    ...
    },
    {
      ...
      "prompt": "Import the `os` module. Check if 'missing.txt' exists using `os.path.exists('missing.txt')`. Print the result.",
      "starterCode": "import os\n# Check existence and print\n",
    ...
    },
    {
      ...
      "testCases": [
        {
          "input": "",
          "expectedOutput": "{\"theme\": \"dark\", \"port\": 8080}\n"
        }
      ],
      "difficulty": "expert",
      "xpReward": 100
