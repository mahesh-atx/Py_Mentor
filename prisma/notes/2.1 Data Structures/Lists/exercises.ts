  ...
  "list-creating": [
    {
      ...
      testCases: [
        { input: "", expectedOutput: "['red', 'green', 'blue']\n3\n" }
      ],
      difficulty: "beginner",
      xpReward: 15
    },
  ...
  "list-methods-remove": [
    {
      ...
      testCases: [
        { input: "", expectedOutput: "['apple', 'cherry', 'banana']\n" }
      ],
      difficulty: "beginner",
      xpReward: 15
    },
  ...
  "list-methods-organize": [
    {
      ...
      testCases: [
        { input: "", expectedOutput: "[9, 8, 5, 3, 2, 1]\n" }
      ],
      difficulty: "beginner",
      xpReward: 15
    },
  ...
  "list-comprehension": [
    {
      ...
      testCases: [
        { input: "", expectedOutput: "[1, 4, 9, 16, 25, 36, 49, 64, 81, 100]\n" }
      ],
      difficulty: "beginner",
      xpReward: 20
    },
